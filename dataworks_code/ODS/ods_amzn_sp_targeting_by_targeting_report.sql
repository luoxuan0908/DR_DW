...
--********************************************************************--
--author:Ada
--create time:2024-04-06 01:47:09
--********************************************************************--
drop table if EXISTS   whde.ods_amzn_sp_targeting_by_targeting_report;
CREATE TABLE IF NOT EXISTS whde.ods_amzn_sp_targeting_by_targeting_report(
    ...
    STORED AS ALIORC
    TBLPROPERTIES ('comment'='亚马逊sp广告投放报告')
    LIFECYCLE 30;



INSERT OVERWRITE TABLE ods_amzn_sp_targeting_by_targeting_report PARTITION (ds)
SELECT    tenant_id ,
          profile_id,
          report_id,
          report_type,
          ...
          "adv_report" data_src,
          "amzn_sp_targeting_by_targeting_report" table_src,
          '${bizdate}' data_dt,
          GETDATE()  etl_data_dt,
    ...
    (
        SELECT
            ...
            case when ad_keyword_status = 'null' then null else ad_keyword_status end as ad_keyword_status
                ,ROW_NUMBER() OVER (PARTITION BY profile_id,campaign_id,ad_group_id,keyword_id,report_date ORDER BY pt DESC ) AS rn
        FROM    whde.amzn_sp_targeting_by_targeting_report
