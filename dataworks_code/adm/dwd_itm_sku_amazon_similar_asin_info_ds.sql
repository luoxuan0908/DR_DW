...
--********************************************************************--
--author:Ada
--create time:2024-05-01 22:58:41
--********************************************************************--
CREATE TABLE IF NOT EXISTS whde.dwd_itm_sku_amazon_similar_asin_info_ds(
...
INSERT OVERWRITE TABLE dwd_itm_sku_amazon_similar_asin_info_ds PARTITION (ds = '${bizdate}')
