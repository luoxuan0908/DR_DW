...
--********************************************************************--
--author:Ada
--create time:2024-04-28 21:44:22
--********************************************************************--
CREATE TABLE IF NOT EXISTS whde.ods_asq_jdy_asin_list(
...
CREATE TABLE IF NOT EXISTS whde.ods_asq_jdy_target_keyword(
     series STRING COMMENT '系列',
     label_name  STRING COMMENT '标签',
     search_term STRING COMMENT '流量词',
     creator STRING COMMENT 'creator',
     updater STRING COMMENT 'updater',
     deleter STRING COMMENT 'deleter',
     createtime STRING COMMENT 'createTime',
