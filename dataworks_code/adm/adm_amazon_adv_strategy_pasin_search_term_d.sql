...
--********************************************************************--
--author:Ada
--create time:2024-05-03 21:44:06
--********************************************************************--
CREATE TABLE IF NOT EXISTS whde.adm_amazon_adv_strategy_pasin_search_term_d(
...
INSERT OVERWRITE TABLE adm_amazon_adv_strategy_pasin_search_term_d PARTITION (ds = '${bizdate}')
SELECT  a.tenant_id
     ,profile_id
     ,a.marketplace_id
     ,marketplace_name
...
FROM    (
    ...
    WHERE   ws = MAX_PT('dwd_itm_spu_amazon_search_keyword_info_ws')
