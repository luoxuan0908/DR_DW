...
--********************************************************************--
--author:Ada
--create time:2024-05-30 00:38:12
--********************************************************************--
--odps sql
--********************************************************************--
--author:王敏佳
--create time:2024-01-11 14:55:19
--********************************************************************--


create table if not exists dws_mkt_adv_strategy_opt_adjust_bid_result_ds
(
...
(
    ...
    stored as aliorc
    tblproperties ('comment' = '投放词寻优竞价调整结果记录')
    lifecycle 30
;
