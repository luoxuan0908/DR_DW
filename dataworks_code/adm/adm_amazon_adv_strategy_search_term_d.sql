...
--********************************************************************--
--author:Ada
--create time:2024-05-01 22:46:24
--********************************************************************--

CREATE TABLE IF NOT EXISTS whde.adm_amazon_adv_strategy_search_term_d(
...
--广告活动下的花费最高的父asin
INSERT OVERWRITE TABLE adm_amazon_adv_strategy_search_term_d PARTITION (ds = '${bizdate}')
--最近30天的搜索词的效果
SELECT  a.tenant_id
     ,a.profile_id
     ,a.marketplace_id
...
FROM    (
    ...
    FROM    (select * from whde.dwd_itm_spu_amazon_search_keyword_info_ws
