...
CREATE TABLE IF NOT EXISTS amz.dws_stg_search_term_pasin_rank_ds
(
...
from (
         ...
         from  amz.dwd_adv_similar_asin_info_ds-- whde.dwd_itm_sku_amazon_similar_asin_info_ds
...
--支持重跑
alter table amz.dws_stg_search_term_pasin_rank_ds drop if exists partition (ds = '${bizdate}');

--插入最新数据
insert into table amz.dws_stg_search_term_pasin_rank_ds partition (ds = '${bizdate}')
(
 marketplace_id
,search_term
,top_parent_asin
