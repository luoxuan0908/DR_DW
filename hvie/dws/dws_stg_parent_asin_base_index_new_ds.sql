...
CREATE TABLE IF NOT EXISTS amz.dws_stg_parent_asin_base_index_new_ds(
...
--
-- --支持重跑
-- alter table amz.dws_stg_parent_asin_base_index_new_ds drop if exists partition (ds = '${bizdate}');
--
-- --插入最新数据
-- insert into table amz.dws_stg_parent_asin_base_index_new_ds partition (ds = '${bizdate}')
-- (
--  tenant_id
-- ,profile_id
-- ,marketplace_id
