CREATE TABLE IF NOT EXISTS amz.dwd_adv_sp_search_term_ds(
...
insert OVERWRITE table amz.dwd_adv_sp_search_term_ds partition(ds)
select  tenant_id
     ,profile_id
     ,market_place_id
     ,report_id
     ...
     ,etl_data_dt
     ,ds
from amz.mid_amzn_sp_search_term_by_search_term_report_ds
