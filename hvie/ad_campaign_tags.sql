CREATE TABLE IF NOT EXISTS dwd.dwd_adv_campaign_tags (
...
INSERT INTO dwd.dwd_adv_campaign_tags PARTITION (ds='2024-08-15')
SELECT
...
FROM
    (
        select * from ods.ods_report_amzn_sp_campaigns_by_campaign_report_df where ds ='20240813'
    ) t1
        left join (
        SELECT *
